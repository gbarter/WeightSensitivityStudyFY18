...
def mysetup(myobj, discrete=True):
    ...
    myobj.add_design_variable('mooring_line_length', 2e2, 3.5e3)
    myobj.add_design_variable('anchor_radius', 1e2, 5.3e3)
    myobj.add_design_variable('mooring_diameter', 0.02, 0.165)
