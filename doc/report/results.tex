...
\begin{table}[htbp]
  \begin{center}
    ...
    \begin{tabular}{l|cc|cc|cc}
      ...
      \textit{Objective function} & \textit{Mass} & \textit{Cost} & \textit{Mass} & \textit{Cost} & \textit{Mass} & \textit{Cost}\\
      \hline \hline
...
\subsection{Optimized Spar Design}
...
\subsection{Optimized Tension Leg Platform Design}
...
\section{Break-Even Cost Point for Nacelle Mass Reduction}
